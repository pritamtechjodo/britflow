        ...
        <div className="container mx-auto px-4 my-10 sm:px-8 lg:px-20">
            <div className="p-4">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-xl sm:text-2xl font-bold mb-2 ml-5 sm:mb-0">Hot Products</h1>
                    <a href="#" className="text-gray-500 mt-2 mr-6 sm:mt-0">See More</a>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-2 px-5 md:grid-cols-3 lg:grid-cols-4 gap-6">
